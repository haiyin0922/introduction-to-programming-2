...
void StageSelectScene::Initialize() {
	...
	AddNewObject(new Engine::Image("stage-select/choose.png", 0, 0, 1200, 604));

    Engine::ImageButton* btn;
    btn = new Engine::ImageButton("stage-select/easy.png", "stage-select/easy-2.png", halfW - 135, halfH / 2 - 100, 70, 380);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::PlayOnClick, this, 1));
    AddNewControlObject(btn);
    //AddNewObject(new Engine::Label("Stage 1", "pirulen.ttf", 48, halfW, halfH / 2, 0, 0, 0, 255, 0.5, 0.5));
    btn = new Engine::ImageButton("stage-select/normal.png", "stage-select/normal-2.png", halfW - 35, halfH / 2 - 100, 70, 380);
    btn->SetOnClickCallback(std::bind(&StageSelectScene::PlayOnClick, this, 2));
    AddNewControlObject(btn);
    //AddNewObject(new Engine::Label("Stage 2", "pirulen.ttf", 48, halfW, halfH * 3 / 2, 0, 0, 0, 255, 0.5, 0.5));
	btn = new Engine::ImageButton("stage-select/hard.png", "stage-select/hard-2.png", halfW + 65, halfH / 2 - 100, 70, 380);
	btn->SetOnClickCallback(std::bind(&StageSelectScene::PlayOnClick, this, 3));
	AddNewControlObject(btn);

	AudioHelper::PlayAudio("choose.wav");
	/*
